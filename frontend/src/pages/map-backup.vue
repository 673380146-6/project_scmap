  ...
  <div class="container">
    ...
    <main class="main">
      <div class="top-bar">
        ...
        <div class="settings">
          <a href="/" class="home-button">� กลับหน้าหลัก</a>
        </div>
      </div>
...
// ไม่มีฟังก์ชัน logout - ระบบไม่มี authentication
...
onMounted(async () => {
  ...
  if (userId && userName) {
    ...
    // ถ้าไม่ได้ล็อกอิน ใช้ข้อมูลเริ่มต้น (เว้นว่างเพื่อไม่แสดงข้อความต้อนรับ/แจ้งเตือน)
    user.value = {
      fullName: '',
      facultyMajor: '',
      profilePic: ''
